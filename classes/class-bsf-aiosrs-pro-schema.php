...
if ( ! class_exists( 'BSF_AIOSRS_Pro_Schema' ) ) {
	...
	class BSF_AIOSRS_Pro_Schema {
		...
		public function bsf_get_specific_meta_fields() {
			...
			// WPCS: unprepared SQL OK.
			$aiosrs_meta_array = $wpdb->get_results( $wpdb->prepare( "SELECT DISTINCT meta_key FROM {$wpdb->postmeta} WHERE meta_key LIKE %s", '%' . $wpdb->esc_like( $search_string ) . '%' ), ARRAY_A ); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared
		...
		public function init_schema_fields() {
			...
			self::$schema_meta_fields = apply_filters(
				...
				array(
					...
					'bsf-aiosrs-faq-page'             => array(
						'key'            => 'faq-page',
						'icon'           => 'dashicons dashicons-editor-help',
						'label'          => __( 'FAQ Page', 'wp-schema-pro' ),
						'guideline-link' => 'https://developers.google.com/search/docs/data-types/faqpage',
						'path'           => BSF_AIOSRS_PRO_DIR . 'classes/schema/',
						'subkeys'        => array(
							'questions' => array(
								'label'  => esc_html__( 'Questions & Answers', 'wp-schema-pro' ),
								'type'   => 'repeater',
								'fields' => array(
									'question' => array(
					...
					'bsf-aiosrs-collection-page'      => array(
						'key'            => 'collection-page',
						'icon'           => 'dashicons dashicons-category',
						'label'          => __( 'Collection Page', 'wp-schema-pro' ),
						'guideline-link' => 'https://schema.org/CollectionPage',
						'path'           => BSF_AIOSRS_PRO_DIR . 'classes/schema/',
						'subkeys'        => array(
							'name'        => array(
								'label'   => esc_html__( 'Name', 'wp-schema-pro' ),
					...
					'bsf-aiosrs-item-list'            => array(
						'key'            => 'item-list',
						'icon'           => 'dashicons dashicons-list-view',
						'label'          => __( 'Item List', 'wp-schema-pro' ),
						'guideline-link' => 'https://developers.google.com/search/docs/data-types/lists',
						'path'           => BSF_AIOSRS_PRO_DIR . 'classes/schema/',
						'subkeys'        => array(
							'name' => array(
								'label'   => esc_html__( 'Name', 'wp-schema-pro' ),
